...
<#--                                <a href="${servePath}${article.articlePermalink}" class="button-normal"><i-->
<#--                                            class="iconfont icon-caidan"> 阅读全文 </i></a>-->
<#--                            </div>-->
                        </div>
                    </div>
                </div>
                    ...
                    <#if 0 != mostUsedCategories?size>
                        <#list mostUsedCategories as category>
                            ...
                            <a href="${servePath}/category/${category.categoryURI}"
                               ...
                               class="">
                                <span class="card-category-list-name">${category.categoryTitle}</span></a>
                            </li>
                        </#list>
                    </#if>
                </ul>
                                    ...
                                    <#else>
                                        <a href="${servePath}/archives/${archiveDate.archiveDateYear}/${archiveDate.archiveDateMonth}"
                                           ...
                                           title="${archiveDate.archiveDateYear} ${yearLabel} ${archiveDate.archiveDateMonth} ${monthLabel}(${archiveDate.archiveDatePublishedArticleCount})">
                                            <span class="card-archive-list-date">${archiveDate.archiveDateYear} ${yearLabel} ${archiveDate.archiveDateMonth} ${monthLabel}</span>
                                            <span class="card-archive-list-count">${archiveDate.archiveDatePublishedArticleCount}</span>
                                        </a>
                                    </#if>
                                </li>
